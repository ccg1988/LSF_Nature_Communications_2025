...
% for 50shuffles*100stepsEx*100stepsIn=500000, it took almost 4 days
% by CCG @ 2024-06-21
...
AD_Ex_all = 0.901:0.001:1;
AD_In_all = 0.901:0.001:1;
...
%%
% Define the range of values you want to encircle
value_min = 30;
value_max = 50;
...
yticks(0:20:100)
% yticklabels({'1','0.98','0.96','0.94','0.92','0.90'});
